...
"             ")
    ...
    def retranslateUi(self, SignUpWindow):
        ...
        self.logoIcon.setText(_translate("SignUpWindow", "🩸"))
        ...
        self.benefit1.setText(_translate("SignUpWindow", "✓ Jadwal donor yang fleksibel"))
        self.benefit2.setText(_translate("SignUpWindow", "✓ Tracking riwayat donor"))
        self.benefit3.setText(_translate("SignUpWindow", "✓ Dapatkan badge pencapaian"))
        self.benefit4.setText(_translate("SignUpWindow", "✓ Notifikasi jadwal donor"))
